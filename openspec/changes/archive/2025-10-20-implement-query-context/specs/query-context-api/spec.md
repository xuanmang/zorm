# Spec: QueryContext API

## Purpose

Define the API for `QueryContext`, a memory management utility that wraps `std.heap.ArenaAllocator` to optimize temporary allocations during query building operations.
