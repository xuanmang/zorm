...
- **源代码位置**: `src/query/query.zig`
- **修改行号**: 87-93, 948, 1464, 1899
- **受影响结构**: SelectQuery, InsertQuery, UpdateQuery, DeleteQuery
- **Zig 版本**: 0.15.2
- **API 文档**: `/opt/homebrew/Cellar/zig/0.15.2/lib/std/array_list.zig`
